...
def db_with_table(db_path):
    ...
    test_table = CreateTable(
        ...
        comment=None,
        columns=[
            Column(name="id", data_type="INTEGER", not_null=True, unique=False, default=None, comment=None),
            Column(name="name", data_type="TEXT", not_null=True, unique=False, default=None, comment=None),
            Column(name="value", data_type="REAL", not_null=False, unique=False, default=None, comment=None)
        ],
        foreign_keys=[],
        indexes=[]
    )
...
class TestListTables:
    ...
    def test_with_multiple_tables(self, db_with_table):
        ...
        second_table = CreateTable(
            ...
            comment=None,
            columns=[
                Column(name="id", data_type="INTEGER", not_null=False, unique=False, default=None, comment=None),
                Column(name="description", data_type="TEXT", not_null=False, unique=False, default=None, comment=None)
            ],
            foreign_keys=[],
            indexes=[]
        )
...
class TestRunDDL:
    def test_create_table(self, db):
        ...
        test_table = CreateTable(
            ...
            columns=[
                Column(name="id", data_type="INTEGER", not_null=True, unique=False, default=None, comment=None),
                Column(name="name", data_type="TEXT", not_null=False, unique=False, default=None, comment=None)
            ],
            foreign_keys=[],
            indexes=[]
        )
    ...
    def test_create_table_with_foreign_key(self, db_with_table):
        ...
        related_table = CreateTable(
            ...
            columns=[
                Column(name="id", data_type="INTEGER", not_null=True, unique=False, default=None, comment=None),
                Column(name="test_id", data_type="INTEGER", not_null=True, unique=False, default=None, comment=None),
                Column(name="data", data_type="TEXT", not_null=False, unique=False, default=None, comment=None)
            ],
            foreign_keys=[
                ForeignKey(
                    reference_to="test_table",
                    column_pairs=[("test_id", "id")],
                    on_delete="CASCADE",
                    on_update=None
                )
            ],
    ...
    def test_drop_table(self, db_with_table):
        ...
        drop_table = DropTable(table_name="test_table")
    ...
    def test_rename_table(self, db_with_table):
        ...
        rename_table = RenameTable(old_name="test_table", new_name="renamed_table")
...
class TestSelect:
    ...
    def test_aggregation_function(self, db_with_data):
        ...
        result = db_with_data.select("SELECT COUNT(*) as count, AVG(value) as avg_value FROM test_table")
